...
lab3_layer_update_str = """def record_metric(tenant_id, metric_name, metric_unit, metric_value):
...
lab3_product_update_str = """def create_product(event, payload, tenant_id):
    tenantId = tenant_id
