...
def create_tenant_admin_user(event, context):
    ...
    if (tenant_details['dedicatedTenancy'] == 'true'):
        ...
        user_pool_id = None  # learner: call user_mgmt.create_user_pool and capture Id
        app_client_id = None  # learner: call user_mgmt.create_user_pool_client and capture ClientId
        # learner: also call user_mgmt.create_user_pool_domain(user_pool_id, tenant_id)
