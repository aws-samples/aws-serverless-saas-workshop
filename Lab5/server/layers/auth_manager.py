            ...
            "Statement": [
                {
                    ...
                    "Resource": [
                        "arn:aws:dynamodb:{0}:{1}:table/ServerlessSaaS-TenantUserMapping-lab5".format(region, aws_account_id),
                        "arn:aws:dynamodb:{0}:{1}:table/ServerlessSaaS-TenantDetails-lab5".format(region, aws_account_id)
                    ],
                    "Condition": {
